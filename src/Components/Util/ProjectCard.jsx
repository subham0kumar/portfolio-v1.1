...
const ProjectCard = ({ title, desc, imgUrl, gitLink, liveUrl }) => {
  ...
  return (
    <div className="relative flex justify-center font-poppins w-[40vw] rounded-md my-8">
      <div
        className="group bg-background border-2 border-primary rounded-lg w-[35vw] h-[14rem] hover:cursor-pointer bg-cover bg-no-repeat bg-blend-normal hover:bg-blend-overlay"
